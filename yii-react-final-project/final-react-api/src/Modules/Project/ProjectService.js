            ...
            <tbody >
            {
                props.database.map((value, index)=>{
                    ...
                    <tr key={index}>
                        ...
                        <Td><Edit other = {{onClick:() => {props.onEdit(value.project_id)}}} buttonName = "Edit"></Edit></Td>
                        <Td><Delete other = {{onClick:() => {props.onDelete(value.project_id)}}} buttonName = "Delete"></Delete></Td>
                    </tr>);
                })
            }
            </tbody>

...
function showuser() {
    ...
    user_records.forEach((item, index) => {
        ...
        h1 += `
            ...
            <td><button type="button" class="btn btn-danger" onclick="deleteUser(${index})" >Delete</button></td> 
        </tr>
        ...
        h1 += `
            <tbody>
                <tr> 
                    ...
                    <td><button type="button" class="btn btn-danger" onclick="deleteUserAddress(${index})" >Delete</button></td> 
                </tr>
            </tbody>
            `
    });

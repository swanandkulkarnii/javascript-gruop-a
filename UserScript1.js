...
function search(searchdata) {
  ...
  user_records.forEach((item, index) => {
    if (item.isDeleted === false) {
      let tempData = searchdata.toUpperCase();let tempfname = item.fname.toUpperCase(); let templname = item.lname.toUpperCase();
      let tempgender = item.gender.toUpperCase();let tempemail = item.email.toUpperCase();
...
function edituser(index) {
  ...
  editvalue1 = user_records[index];
  f_name.value = editvalue1.fname;
  l_name.value = editvalue1.lname;
  g_ender.value = editvalue1.gender;
  e_mail.value = editvalue1.email;
}
function Update() {
